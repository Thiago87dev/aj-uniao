  ...
  return (
    <section id='faq' aria-labelledby='faq-titulo' className='grid gap-10 bg-[#f3f6fa] px-5 py-16 text-background sm:px-10 lg:grid-cols-[0.8fr_1.2fr] lg:px-16 lg:py-24 xl:px-40'>
      <div className='min-w-0'>
        ...
        <a href={whatsappHref} className='mt-6 hidden lg:inline-block font-bold text-primary underline underline-offset-4'>Ainda tem uma dúvida? Fale com a gente.</a>
      </div>
      ...
      <a href={whatsappHref} className='font-bold leading-7 text-primary underline underline-offset-4 lg:hidden'>Ainda tem uma dúvida? Fale com a gente.</a>
    </section>
  );
}
